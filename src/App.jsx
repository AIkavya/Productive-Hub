                            ...
                            <div key={habit.id} className="rounded-lg p-4 t-surface">
                                <div className="flex items-start justify-between gap-3 mb-3">
                                    <div className="flex items-center gap-3">
                                        ...
                                        <h3 className={`text-lg font-bold t-muted ${isCompletedToday ? 'line-through text-gray-500' : ''}`}>{habit.name}</h3>
                                        <span className={`px-2 py-1 rounded text-xs font-semibold ${isCompletedToday ? 'bg-green-500/20 text-green-400' : 't-pill'}`}>🔥 {streak} day streak</span>
                                    </div>
